...
3. Create a layout plan from `references/layout-contract.md`.
4. Optionally create a layout guide with `scripts/make_layout_guide.mjs`.
5. Generate layered UI assets and composition recipes.
6. Write `layout_data.json` with anchors, frames, z-index, safe areas, responsive rules, and sync rules.
