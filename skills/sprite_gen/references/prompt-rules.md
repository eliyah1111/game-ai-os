...
Use these rules for `$SPRITE_GEN` prompts.

## Required Language

- modern mobile casual game asset
...
- same body scale and same anchor in every frame
- full subject inside each cell

## Good Prompt Shape

```text
Create a 2x3 animation sheet for a cute glossy flying cube mascot in a modern mobile puzzle game.
Use the active Style Lock profile: Glossy Mobile Arcade.
